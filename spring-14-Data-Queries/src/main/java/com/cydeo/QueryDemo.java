...
public class QueryDemo implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println("____________Regions____________");
        System.out.println("findByCountry:" + regionRepository.findByCountry("Canada"));
        System.out.println("findByCountryContaining:" + regionRepository.findByCountryContaining("United"));
        System.out.println("findByCountryContainingOrderByRegion:" + regionRepository.findByCountryContainsOrderByRegion("United"));
        ...
        System.out.println("findDistinctTop3ByDivisionContains: "+ departmentRepository.findDistinctTop3ByDivisionContains("ics"));
